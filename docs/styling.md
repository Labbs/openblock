...
OpenBlock uses CSS custom properties for theming and is designed to work with modern design systems like shadcn/ui.

## CSS Loading Options

### Option 1: Auto-injection (Default)

By default, OpenBlock automatically injects styles into the document head:
...
OpenBlock uses these CSS variables with fallback values:
...
If you're using shadcn/ui, OpenBlock automatically picks up your theme variables:
...
OpenBlock will use these values automatically.
...
```css
.dark .openblock-editor,
[data-theme="dark"] .openblock-editor {
...
.openblock-editor tr:nth-child(even) td {
